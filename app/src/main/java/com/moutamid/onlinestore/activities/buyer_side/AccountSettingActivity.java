...
import com.moutamid.onlinestore.activities.seller_side.UpdateProfileActivity;
import com.moutamid.onlinestore.constants.Constants;
import com.moutamid.onlinestore.databinding.ActivityAccountSettingBinding;
...
public class AccountSettingActivity extends AppCompatActivity {
        ...
        Constants.databaseReference().child(Constants.User).child(Constants.auth().getCurrentUser().getUid())
                .get().addOnSuccessListener(dataSnapshot -> {
                    if (dataSnapshot.exists()) {
                        ...
                        Glide.with(AccountSettingActivity.this).load(userModel.getImage()).placeholder(R.drawable.profile_icon).into(binding.profile);
                    }
    ...
    private void showDialog() {
        ...
        openCamera.setText("Take photo with camera");
        openGallery.setText("Take photo with gallery");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == IMAGE_CODE) {
            if (resultCode == RESULT_OK && data != null) {
                image = data.getData();
                Glide.with(AccountSettingActivity.this).load(image).addListener(new RequestListener<Drawable>() {
                    @Override
                    public boolean onLoadFailed(@Nullable GlideException e, Object model, Target<Drawable> target, boolean isFirstResource) {
                        Constants.dismissDialog();
                        Snackbar.make(AccountSettingActivity.this, binding.root, "Something went wrong", Snackbar.LENGTH_SHORT).show();
                        return false;
                    }
