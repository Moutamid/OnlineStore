...
public class SearchProductAdapter extends RecyclerView.Adapter<SearchProductAdapter.CategoryVH> {

    Context context;
    ArrayList<ProductModel> list;

    public SearchProductAdapter(Context context, ArrayList<ProductModel> list) {
    ...
    public CategoryVH onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new CategoryVH(LayoutInflater.from(context).inflate(R.layout.search_product_layout, parent, false));
    }
